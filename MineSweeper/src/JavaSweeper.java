...
public class JavaSweeper extends JFrame
{
    ...
    public String getMessage()
    {
        switch (game.getState())
        {
            ...
            case WINNER: return "Congratulation! You are Winner!" ;
            case PLAYED:
            default    :
    ...
    private void initMenuBar()
    {
        ...
        JMenu help = new JMenu("GAME");
        menuBar.add(help);
        JMenuItem about = new JMenuItem("How to play?");
        help.add(about);

        JMenu res = new JMenu("RESULTS");
        menuBar.add(res);
        JMenuItem results = new JMenuItem("Best results");
        res.add(results);

        setJMenuBar(menuBar);
        results.addActionListener(e -> new ShowDB());
        about.addActionListener(e -> new HelpWindow());
    }
}